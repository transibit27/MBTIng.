...
<body>
    ...
    <section class="p-0 bg-img cover-background" style="background-image: url(${pageContext.request.contextPath}/resources/images/error500.png);">
            ...
            <div class="row align-items-center justify-content-center min-vh-100">
                <div class="col-md-9 col-lg-6 my-5">
                    <div class="text-center error-page">
                        ...
                        <div>
                            <a href="http://localhost:8081/mbting/" class="btn btn-info btn-lg me-sm-2 mb-2 mb-sm-0">Return Home</a>
                        </div>
                    </div>
                </div>
            </div>
